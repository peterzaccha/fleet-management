...
/* harmony import */ var _sortable__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sortable */ "./resources/js/sortable.js");
...
window.livewire.directive("sortable-group", function (el, directive, component) {
  ...
  var sortable = el.livewire_sortable = new (_shopify_draggable_lib_sortable__WEBPACK_IMPORTED_MODULE_0___default())([], options);
  sortable.on("sortable:stop", function () {
    setTimeout(function () {
      var groups = [];
      el.querySelectorAll("[wire\\:sortable-group\\.item-group]").forEach(function (el, index) {
        var items = [];
        el.querySelectorAll("[wire\\:sortable-group\\.item]").forEach(function (el, index) {
          items.push({
            order: index + 1,
...
window.livewire.directive("sortable", function (el, directive, component) {
  ...
  var isPrevented = function isPrevented(element, classesToPrevent) {
    var currentElem = element;
    var isParent = false;

    while (currentElem) {
      var hasClass = Array.from(currentElem.classList).some(function (cls) {
        return classesToPrevent.includes(cls);
      });
  ...
  var sortable = new (_shopify_draggable_lib_sortable__WEBPACK_IMPORTED_MODULE_0___default())(el, options);
  sortable.on("sortable:stop", function () {
    setTimeout(function () {
      var items = [];
      el.querySelectorAll("[wire\\:sortable\\.item]").forEach(function (el, index) {
        items.push({
          order: index + 1,
